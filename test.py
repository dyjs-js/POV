...
# user_text = """
# 타이타닉은 1997년에 개봉한 미국의 로맨스/재난 영화로, 제임스 카메론 감독의 작품이다.
# 영화는 실제로 발생한 1912년 타이타닉호 침몰 사건을 바탕으로 하고 있으며,
# 여성 주인공 로즈와 남성 주인공 잭의 사랑 이야기를 중심으로 전개된다.
# 이 영화는 역사적 사건을 배경으로 하면서도 로맨스와 스릴러적인 요소를 풍미하며
# 관객들에게 강한 여운을 남기는데, 특히 타이타닉호의 침몰 장면은 화려한 시각 효과와 함께 매우 인상적이다.
# """
# chat_completion = client.chat.completions.create(
#     model="gpt-3.5-turbo",
#     messages=[
#         {"role": "system", "content": "user_text의 내용을 5개 이상의 단어로 요약"},
...
# assistant_message = {
#     "role": "assistant",
#     "content": "user_message 의 내용을 5개 이상의 별개의 단어로 요약",
# }
# chat_completion = client.chat.completions.create(
#     model="gpt-3.5-turbo",
...
def get_completion(prompt):
    query = client.images.generate(
        model="dall-e-3",
        prompt=prompt,  # 문자열 형태로 전달되어야 합니다.
        n=1,
        size="1024x1024",
    )
